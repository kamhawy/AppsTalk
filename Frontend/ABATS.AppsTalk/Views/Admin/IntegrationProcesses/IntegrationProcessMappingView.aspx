<%@ Page Title="Integration Process Mapping" Language="C#" MasterPageFile="~/Full.Master"
...
<asp:Content ID="ContentIntegrationProcessMappingView" ContentPlaceHolderID="FullContentPlaceHolder"
    runat="server">
    <div id="divInnerContainer" class="innerPanelContainer">
        <div id="divIntegratoinProcessMapping" class="ShadowBox" style="margin: 0px 0px 5px 0px; width: 99.8%;"
            runat="server">
            <div class="ShadowBoxHeader">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td valign="middle" class="BoxHeaderText">Integratoin Process Mapping [
                            <asp:Label ID="lblIntegrationProcessTitle" runat="server"></asp:Label>
                            ]
                        </td>
                    </tr>
                </table>
                ...
                <asp:GridView ID="dgvList" runat="server" DataSourceID="IntegrationProcessMappingsDataSource"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Source Field" HeaderStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="lblSourceIntegrationAdapterFieldName" Text='<%# Eval("SourceIntegrationAdapterFieldName") %>'
                                    runat="server"></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:DropDownList ID="cmbSourceField" DataSourceID="SourceFieldMappingObjectDataSource"
                                    SelectedValue='<%# Bind("SourceIntegrationAdapterFieldID") %>' Width="95%" DataTextField="FieldName"
                                    DataValueField="IntegrationAdapterFieldID" AppendDataBoundItems="true" runat="server">
                        ...
                        <asp:TemplateField HeaderText="Destination Field" HeaderStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="lblDestinationIntegrationAdapterFieldName" Text='<%# Eval("DestinationIntegrationAdapterFieldName") %>'
                                    runat="server"></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:DropDownList ID="cmbDestinationField" DataSourceID="DestinationFieldMappingObjectDataSource"
                                    SelectedValue='<%# Bind("DestinationIntegrationAdapterFieldID") %>' Width="95%" DataTextField="FieldName"
                                    DataValueField="IntegrationAdapterFieldID" AppendDataBoundItems="true" runat="server">
    ...
    <asp:ObjectDataSource ID="SourceFieldMappingObjectDataSource" runat="server" SelectMethod="GetSourceFields"
        TypeName="ABATS.AppsTalk.Presentation.IntegrationProcessMappingPresenter" DataObjectTypeName="ABATS.AppsTalk.Data.IntegrationAdapterField"
    ...
    <asp:ObjectDataSource ID="DestinationFieldMappingObjectDataSource" runat="server"
        ...
        DataObjectTypeName="ABATS.AppsTalk.Data.IntegrationAdapterField" OnObjectCreating="ObjectDataSource_ObjectCreating"
        OnObjectDisposing="ObjectDataSource_ObjectDisposing">
        <SelectParameters>
            <asp:QueryStringParameter Name="pIntegrationProcessID" QueryStringField="IntegrationProcessID"
                Type="Int32" />
