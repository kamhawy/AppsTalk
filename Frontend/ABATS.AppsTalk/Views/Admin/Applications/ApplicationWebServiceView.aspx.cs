...
{
    /// <summary>
    /// Application Web Service View
    /// </summary>
    public partial class ApplicationWebServiceView : EntityView<ApplicationWebService, ApplicationWebServicePresenter>
    {
                ...
                default:
                    {
                        ...
                        this.divApplicationWebServiceRequests.Visible = false;
                    }
                    break;
                case UIMode.Admin:
                case UIMode.Edit:
